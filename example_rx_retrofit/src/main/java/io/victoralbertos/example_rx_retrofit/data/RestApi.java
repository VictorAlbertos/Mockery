...
import io.victoralbertos.example_rx_retrofit.data.Mockeries.ReposDTO;
import io.victoralbertos.example_rx_retrofit.data.Mockeries.UserDTO;
import io.victoralbertos.example_rx_retrofit.data.Mockeries.UsersDTO;
...
@RxRetrofit(errorResponseAdapter = RestApi.GithubResponseAdapter.class)
public interface RestApi {
  ...
  Observable<Response<User>> getUserByName(@Valid(value = STRING, legal = "google") @Path("username") String username);
  ...
  @DTO(ReposDTO.class)
  Observable<Response<List<Repo>>> getRepos(@Valid(value = STRING, legal = "google") @Path("username") String username,
