...
import io.victoralbertos.mockery.internal.built_in_interceptor.RetrofitInterceptor;
...
@Retention(RUNTIME)
@Target(TYPE)
@Interceptor(RetrofitInterceptor.class)
 ...
 * Every declared method has to return a {@link Call} object and any DTO annotated has to limit its creation scope to the DTO itself,
 * that’s mean that this interceptor is responsible for creating and managing the {@link Call} objects, not the client.
 * To use it, annotate Retrofit interface with this Retrofit annotation.
 */
